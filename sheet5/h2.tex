...
\begin{enumerate}[label=\alph*)]
   ...
   \item
      ...
      \begin{equation*}
         \dd{a} = - \frac{a}{T} \dd{T}
      \end{equation*}
      The integral on RHS gets flipped because of the negative sign
      \begin{align*}
      ...
      \end{align}
      \fi
   \item The Universe transitioned from radiation dominated to matter dominated at $\SI{0.76}{\eV}$. Thus in order to get the correct time of last scattering, one need to include radiation.
\end{enumerate}
